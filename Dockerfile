ARG PHP_VERSION=8.5.6-alpine   # https://hub.docker.com/_/php/tags?page=1&name=8.5
ARG COMPOSER_VERSION=2.9.8     # https://hub.docker.com/_/composer/tags
ARG PHPEXTINST_VERSION=2.10.16 # https://github.com/mlocati/docker-php-extension-installer/releases
